...
test('Phase 9F migration is the sole repeatable terminal migration', () => {
  const manifest = readPhase9MigrationManifest();
  assert.equal(PHASE9_TERMINAL_MIGRATION, 'supabase/phase9f_inventory_structured_quantities.sql');

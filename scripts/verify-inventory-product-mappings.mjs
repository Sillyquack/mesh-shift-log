...
test('Phase 9G-D remains the product-mapping layer before repeatable Phase 9H-9K and terminal Phase 9P', () => {
  ...
  assert.equal(entries.at(-10).path, PHASE9_PRODUCT_MAPPING_MIGRATION);

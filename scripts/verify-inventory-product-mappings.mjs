...
test('Phase 9G-D remains the product-mapping layer before repeatable Phase 9H through terminal Phase 9K', () => {
  ...
  assert.equal(entries.at(-9).path, PHASE9_PRODUCT_MAPPING_MIGRATION);

...
test('Phase 9G-B2 through Phase 9G-D remain before the repeatable Phase 9H terminal layer', () => {
  ...
  assert.equal(entries.at(-4).path, 'supabase/phase9gb2_inventory_counter_replacement.sql');

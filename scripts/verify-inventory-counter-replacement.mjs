...
test('Phase 9G-B2 through Phase 9G-D remain before repeatable Phase 9H-9K and terminal Phase 9P', () => {
  ...
  assert.equal(entries.at(-11).path, 'supabase/phase9gc_inventory_counter_mobile.sql');
  assert.equal(entries.at(-12).path, 'supabase/phase9gb2_inventory_counter_replacement.sql');

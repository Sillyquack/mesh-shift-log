...
const paths={pack:"content/routine-engine/mesh-routine-content-v1.json",generator:"scripts/generate-routine-content-pack.mjs",doc:"docs/routine-engine-v2-mesh-content-v1.md",amendment:"docs/routine-engine-v2-mesh-operational-standards-amendment-2026-08-07.md",fixture:"supabase/tests/phase10/content-pack-fixtures.sql",assertions:"supabase/tests/phase10/content-pack-assertions.sql"};
...
function sourceChecks(){
  ...
  const pack=JSON.parse(readFileSync(absolute(paths.pack),"utf8"));const generator=readFileSync(absolute(paths.generator),"utf8");const sql=readFileSync(absolute(contentMigration),"utf8");
  check("full Phase 10 manifest ends with 10L then 10O",migrations.length===17&&migrations.at(-2)===contentMigration&&migrations.at(-1)===securityMigration);

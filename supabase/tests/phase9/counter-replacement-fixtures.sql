...
insert into public.inventory_locations (
  ...
  ('b2200000-0000-4000-8000-000000000001', 'b2000000-0000-4000-8000-000000000001', 'Preserve Fridge', 'CORNERBAR_LEFT_FRIDGE', 'fridge', true, 1, 'b2600000-0000-4000-8000-000000000001', 'b2600000-0000-4000-8000-000000000001'),
  ('b2200000-0000-4000-8000-000000000002', 'b2000000-0000-4000-8000-000000000001', 'Clear Fridge', 'CORNERBAR_MIDDLE_FRIDGE', 'fridge', true, 2, 'b2600000-0000-4000-8000-000000000001', 'b2600000-0000-4000-8000-000000000001'),
  ('b2200000-0000-4000-8000-000000000003', 'b2000000-0000-4000-8000-000000000001', 'Returned Fridge', 'CORNERBAR_RIGHT_FRIDGE', 'fridge', true, 3, 'b2600000-0000-4000-8000-000000000001', 'b2600000-0000-4000-8000-000000000001'),
  ('b2200000-0000-4000-8000-000000000004', 'b2000000-0000-4000-8000-000000000001', 'Accepted Fridge', 'WORKBAR_BAR_LEFT_FRIDGE', 'fridge', true, 4, 'b2600000-0000-4000-8000-000000000001', 'b2600000-0000-4000-8000-000000000001'),
  ('b2200000-0000-4000-8000-000000000005', 'b2000000-0000-4000-8000-000000000001', 'Submitted Fridge', 'WORKBAR_BAR_RIGHT_FRIDGE', 'fridge', true, 5, 'b2600000-0000-4000-8000-000000000001', 'b2600000-0000-4000-8000-000000000001'),
  ('b2200000-0000-4000-8000-000000000006', 'b2000000-0000-4000-8000-000000000001', 'Concurrent Fridge', 'WORKBAR_NON_ALCO_FRIDGE', 'fridge', true, 6, 'b2600000-0000-4000-8000-000000000001', 'b2600000-0000-4000-8000-000000000001');
...
insert into public.inventory_locations (
  ...
  'Final history fridge', 'CORNERBAR_LEFT_FRIDGE', 'fridge', true,

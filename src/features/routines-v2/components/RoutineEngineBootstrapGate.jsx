...
export default function RoutineEngineBootstrapGate({ user, open = true, loader, operatorApi, subscribe, onBack, onOpenEmployee, onOpenManager }) {
  ...
  return <RoutineEnginePreviewHome bootstrap={bootstrap.data} syncStatus={syncStatus} onOpenEmployee={onOpenEmployee} onOpenManager={onOpenManager}

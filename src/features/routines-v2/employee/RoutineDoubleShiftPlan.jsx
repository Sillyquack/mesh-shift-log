export default function RoutineDoubleShiftPlan({ context, pending, onConfirm, onOpenRun }) {
  ...
  return <section className="employee-ds-card"><p className="eyebrow">DS01 · Plan</p><h2>Confirm the Double Shift plan</h2>
    ...
    <button type="button" className="employee-primary" disabled={!context.actions?.canConfirmDS01?.allowed || pending} onClick={onConfirm}>Confirm and start Opening</button>

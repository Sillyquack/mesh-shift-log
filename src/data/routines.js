...
export const defaultRoutines = [
  ...
  section('opening-1000', 'opening', 'Opening 10:00-11:00', [
    ...
    ['Clean/reset project rooms (001-006 + boardroom) after use', { area: 'project_rooms' }],
  ]),
  section('lunch-1100', 'daytime', 'Lunch 11:00-13:00', [
    ['Turn music up for good energy lunch-vibe', { area: 'general', recurring: { type: 'weekdays', days: ['wednesday', 'thursday', 'friday'] } }],
  ...
  section('preclosing-1500', 'closing', 'Pre-closing 15:00-18:00', [
    ...
    ['Clean meeting rooms (001-006 + boardroom) and prepare cups/glasses for next day', { area: 'project_rooms', priority: 'important' }],
  ...
  section('closing-1800', 'closing', 'After closing 18:00-19:00', [
    ...
    ['Close register', { area: 'pos', priority: 'critical', criticalConfirm: true }],
  ...
  section('event-before', 'event', 'Event before', [
    ['Check Google Calendar', { area: 'event', priority: 'important' }],
  ...
  section('event-closing-cornerbar', 'event', 'Event closing Cornerbar', [
    ...
    ['Send invoice and close register', { area: 'pos', priority: 'critical', criticalConfirm: true }],
    ...
    ['Lock street door, both physically locking security lock (upper lock) and in Salto, and make sure Atrium door is closed and locked', { area: 'security', priority: 'critical', criticalConfirm: true }],

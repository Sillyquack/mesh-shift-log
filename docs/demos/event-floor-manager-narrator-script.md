...
## 02 — Exact standards at the point of work (14 seconds)
...
## 04 — During the event (14 seconds)
...
## 05 — Financial control (9 seconds)
...
## 08 — Management visibility (10 seconds)
...
## 09 — Event runbook vision (16 seconds)
...
- Do not read capability labels such as `LIVE NOW` or `PARTIAL / PILOT`; those are visual honesty markers.
- Keep product-language emphasis on readiness, ownership, exceptions, handover and verified closeout.
- Avoid a sales-announcer cadence. The intended feeling is a calm operations leader showing how the floor works.
- Leave audio off by default if a recording is added later. Preserve captions and all playback controls.

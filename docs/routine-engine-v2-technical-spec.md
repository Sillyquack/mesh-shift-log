...
Production remains `legacy/staff_preview`; Phase 10O has not been applied there and shadow remains blocked until a separately authorized application and all three attestations pass. Existing production Routine objects were already secure, no database rollback is required, and only future-object defaults need forward hardening. This verification performs no production migration or data operation.

## Phase 10L versioned Mesh content pack

Phase 10L started from the clean K4 checkpoint `fc8225d66fe702f0959765f499cc6cf7aebe0166` (`feat: add routine history and pilot hardening`). Phase 10M applies the approved 2026-08-07 operational-standards amendment on the merged source checkpoint `467d2c116ba4e07e411f4b1b21764c0293a4ed3f`. The single canonical manifest remains `content/routine-engine/mesh-routine-content-v1.json`: the generator verifies the three unchanged re-locked Opening, Closing and Double Shift source hashes, hashes only the decision body of the human amendment (excluding its generated pack-metadata section), and applies both layers deterministically. `mesh-routine-content@1.1R` has pack hash `c149a8416a867dcb7d87224f3ae8e2a214e5ca4954613b118521ebe5ae3aff2a`, 37 Opening tasks in three sections, 46 Closing tasks in two sections, and four Double Shift system-step definitions plus bundle copy. Double Shift remains a bundle over linked Opening and Closing runs and is never a third routine template.
